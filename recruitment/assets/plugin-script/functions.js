...
jQuery(".careerfy-click-btn").on("click", function (e) {
  jQuery(this)
    .parents(".careerfy-search-filter-toggle")
    .find(".careerfy-checkbox-toggle")
    .slideToggle("slow", function () {});
  jQuery(this)
    .parents(".careerfy-search-filter-toggle")
    .toggleClass("careerfy-remove-padding", function () {});
  return false;
});
...
jQuery(".careerfy-resume-addbtn").on("click", function (e) {
  jQuery(this)
    .parents(".careerfy-candidate-resume-wrap")
    .find(".careerfy-add-popup")
    .slideToggle("slow", function () {});
  return false;
});
